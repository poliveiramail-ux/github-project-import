  ...
  public: {
    Tables: {
      ...
      simulation_configs_variables_duplicate: {
        ...
        Relationships: [
          {
            foreignKeyName: "simulation_configs_variables_duplicate_id_lang_fkey1"
            columns: ["id_lang"]
            isOneToOne: false
            referencedRelation: "lang"
            referencedColumns: ["id_lang"]
          ...
          {
            foreignKeyName: "simulation_configs_variables_duplicate_id_lob_fkey1"
            columns: ["id_lob"]
            isOneToOne: false
            referencedRelation: "lob"
            referencedColumns: ["id_lob"]
          ...
          {
            foreignKeyName: "simulation_configs_variables_duplicate_id_sim_cfg_fkey1"
            columns: ["id_sim_cfg"]
            isOneToOne: false
            referencedRelation: "simulation_configs"
            referencedColumns: ["id_sim_cfg"]
          ...
          {
            foreignKeyName: "simulation_configs_variables_duplicate_parent_account_id_fkey1"
            columns: ["parent_account_id"]
            isOneToOne: false
            referencedRelation: "simulation_configs_variables"
            referencedColumns: ["id_sim_cfg_var"]
      ...
      simulation_configs_variables_duplicate_old: {
        Row: {
          account_num: string
          blocked: boolean | null
          calculation_type: string | null
